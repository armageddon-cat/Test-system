...
include ("connect.php");
$step5_question = $_SESSION['something_ukr'];
$step5_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 5;
mysql_query("INSERT INTO step5 (step5_question, step5_answer, user_id, true_false, try_id) VALUES('$step5_question', '$step5_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step7.php" autocomplete="on">
