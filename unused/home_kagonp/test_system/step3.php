...
include ("connect.php");
$step2_question = $_SESSION['something_ukr'];
$step2_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 2;
mysql_query("INSERT INTO step2 (step2_question, step2_answer, user_id, true_false, try_id) VALUES('$step2_question', '$step2_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step4.php" autocomplete="on">
