...
include ("connect.php");
$step3_question = $_SESSION['something_ukr'];
$step3_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 3;
mysql_query("INSERT INTO step3 (step3_question, step3_answer, user_id, true_false, try_id) VALUES('$step3_question', '$step3_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step5.php" autocomplete="on">
