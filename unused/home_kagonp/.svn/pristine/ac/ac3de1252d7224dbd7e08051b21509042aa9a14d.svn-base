...
include ("connect.php");
$step4_question = $_SESSION['something_ukr'];
$step4_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 4;
mysql_query("INSERT INTO step4 (step4_question, step4_answer, user_id, true_false, try_id) VALUES('$step4_question', '$step4_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step6.php" autocomplete="on">
