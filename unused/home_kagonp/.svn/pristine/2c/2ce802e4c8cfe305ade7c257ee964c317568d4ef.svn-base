...
include ("connect.php");
$step8_question = $_SESSION['something_ukr'];
$step8_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 8;
mysql_query("INSERT INTO step8 (step8_question, step8_answer, user_id, true_false, try_id) VALUES('$step8_question', '$step8_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step10.php" autocomplete="on">
