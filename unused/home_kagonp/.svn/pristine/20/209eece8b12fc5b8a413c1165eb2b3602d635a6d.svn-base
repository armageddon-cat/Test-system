...
include ("connect.php");
$step1_question = $_SESSION['something_ukr'];
$step1_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
echo "asdfas".$try;
$step = 1;
mysql_query("INSERT INTO step1 (step1_question, step1_answer, user_id, true_false, try_id) VALUES('$step1_question', '$step1_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step3.php" autocomplete="on">
