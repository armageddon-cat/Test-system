...
include ("connect.php");
$step6_question = $_SESSION['something_ukr'];
$step6_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 6;
mysql_query("INSERT INTO step6 (step6_question, step6_answer, user_id, true_false, try_id) VALUES('$step6_question', '$step6_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step8.php" autocomplete="on">
