...
include ("connect.php");
$step7_question = $_SESSION['something_ukr'];
$step7_answer = $_POST["str"];
$userid = $_SESSION['id'];
$try = $_SESSION['number_of_tries'][0];
$step = 7;
mysql_query("INSERT INTO step7 (step7_question, step7_answer, user_id, true_false, try_id) VALUES('$step7_question', '$step7_answer', '$userid', '$res', '$try')");
...
<form id="formtop" method="post" action="step9.php" autocomplete="on">
